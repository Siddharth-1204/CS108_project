...
class MainMenu :
    def __init__(self, background_photo, ttt_logo, othello_logo, connectfour_logo, screen, font):
        self.screen = screen
        self.font = font
        ...
        self.ttt_rect = self.ttt_surf.get_rect(center=(200, 300))
        self.othello_rect = self.othello_surf.get_rect(center=(500, 300))
        self.connectfour_rect = self.connectfour_surf.get_rect(center=(800, 300))
        self.is_active = False
        self.game_selected = False
    def display(self):
        font_surf = self.font.render("Select a game", False, (0, 0, 0))
        font_rect = pygame.Surface.get_rect(font_surf, center = (500, 100))
